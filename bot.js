...
let PB = chalk.pink.bold("Pinky-Bot");
...
async function whatsAsena () {
    ...
    conn.on('connecting', async () => {
        print(`${chalk.green.bold('Whats')}${chalk.blue.bold('Asena')}
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    let SEND_READ = config.SEND_READ
                    if (SEND_READ = true) SEND_READ = false;
                    else SEND_READ = false;
    
                    if (sendMsg) {
                        if (SEND_READ && command.on === undefined) {
